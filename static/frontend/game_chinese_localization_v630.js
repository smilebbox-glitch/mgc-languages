/* v6.0.30 — Russian game UI policy for the Chinese learning track.
 * Game names, descriptions, buttons and production chrome stay Russian.
 * Chinese is reserved for the material being learned; canonical answers stay untouched.
 */
(function (root) {
  'use strict';
  ...
  const GAME_TITLES_RU = Object.freeze({
    ...
    listening:'Аудиоспринт',
    mistake:'Точная проверка',
    phrase:'Конструктор фраз',
    hotspot:'Детали автомобиля',
    assembly_order:'Собери автомобиль',
    shop_route:'Маршрут по заводу',
    tool_select:'Выбор инструмента',
    defect_detective:'Детектор дефектов',
    safety_spot:'Найди опасность',
    quality_gate:'Контроль качества',
    logistics_route:'Логистический поток',
    kanban:'Канбан',
    bom_builder:'Собери BOM',
    spec_check:'Допуск или NOK?',
    rapid_recall:'Быстрый ответ',
    memory_pairs:'Гараж памяти',
    odd_one_out:'Лишний термин',
    dialogue_choice:'Рабочий диалог',
  ...
  const STATIC_RU = Object.freeze({
    ...
    'Factory Hub':'Центр завода',
    'Automotive Arcade':'Автомобильные игры',
    'Garage':'Гараж',
    'MISSION BRIEFING':'ИНСТРУКТАЖ',
    'MISSION FLOW':'ХОД ЗАДАНИЯ',
    'MISSION COMPLETE':'ЗАДАНИЕ ЗАВЕРШЕНО',
    'PASS':'ГОДЕН',
    'REWORK':'ДОРАБОТКА',
    'HOLD':'УДЕРЖАНИЕ',
    'ASSEMBLY LINE · LIVE':'СБОРОЧНАЯ ЛИНИЯ · РАБОТАЕТ',
    'LINE RUNNING':'ЛИНИЯ РАБОТАЕТ',
    'BODY SHOP · ROBOT CELL':'СВАРОЧНЫЙ ЦЕХ · РОБОТ-ЯЧЕЙКА',
    'CELL SAFE':'ЯЧЕЙКА БЕЗОПАСНА',
    'PAINT SHOP · INSPECTION':'ОКРАСКА · КОНТРОЛЬ',
    'INSPECTION ACTIVE':'КОНТРОЛЬ ИДЁТ',
    'INTRALOGISTICS · MATERIAL FLOW':'ВНУТРИЗАВОДСКАЯ ЛОГИСТИКА · МАТЕРИАЛЬНЫЙ ПОТОК',
    'FLOW SYNCHRONIZED':'ПОТОК СИНХРОНИЗИРОВАН',
    'QUALITY GATE':'КОНТРОЛЬ КАЧЕСТВА',
    'SPEC CHECK':'ПРОВЕРКА ДОПУСКА',
    'PRECISION':'ТОЧНАЯ ПРОВЕРКА',
    'NOMINAL':'НОМИНАЛ',
    'MEASUREMENT LIVE':'ИЗМЕРЕНИЕ ИДЁТ',
    'BOM DIGITAL THREAD':'ЦИФРОВАЯ ЦЕПОЧКА BOM',
    'ENGINEERING CLASSIFICATION':'ИНЖЕНЕРНАЯ КЛАССИФИКАЦИЯ',
    'ENGINEERING':'ИНЖЕНЕРИЯ',
    'A3 DRAWING':'ЧЕРТЁЖ A3',
    'REV':'РЕВИЗИЯ',
    'DIGITAL THREAD LINKED':'ЦИФРОВАЯ ЦЕПОЧКА СВЯЗАНА',
    'PROCESS LIVE':'ПРОЦЕСС ИДЁТ',
    'TORQUE VERIFY':'ПРОВЕРКА МОМЕНТА',
    'SAFETY INTERLOCK':'БЛОКИРОВКА БЕЗОПАСНОСТИ',
    'AGV ROUTE':'МАРШРУТ AGV',
    'CMM PROBE':'ЩУП CMM',
    'CONTROL ROOM':'ДИСПЕТЧЕРСКАЯ',
    'PART INSTALL':'УСТАНОВКА ДЕТАЛИ',
    'SURFACE SCAN':'СКАН ПОВЕРХНОСТИ',

    /* Undo former Chinese UI-only translations. Learning text is excluded below. */
    '游戏能力 · 技能图谱':'ИГРОВОЙ ПРОФИЛЬ · КАРТА НАВЫКОВ',
    '任务简报':'ИНСТРУКТАЖ',
    '任务进度':'ХОД ЗАДАНИЯ',
    '任务完成':'ЗАДАНИЕ ЗАВЕРШЕНО',
    '游戏世界':'ИГРОВОЙ МИР',
    '工厂中心':'Центр завода',
    '汽车工厂游戏':'Автомобильные игры',
    '车库':'Гараж',
    '总装线 · 运行中':'СБОРОЧНАЯ ЛИНИЯ · РАБОТАЕТ',
    '生产线运行中':'ЛИНИЯ РАБОТАЕТ',
    '焊装车间 · 机器人单元':'СВАРОЧНЫЙ ЦЕХ · РОБОТ-ЯЧЕЙКА',
    '单元安全':'ЯЧЕЙКА БЕЗОПАСНА',
    '涂装车间 · 检查':'ОКРАСКА · КОНТРОЛЬ',
    '检查进行中':'КОНТРОЛЬ ИДЁТ',
    '厂内物流 · 物料流':'ВНУТРИЗАВОДСКАЯ ЛОГИСТИКА · МАТЕРИАЛЬНЫЙ ПОТОК',
    '物流同步':'ПОТОК СИНХРОНИЗИРОВАН',
    '质量关':'КОНТРОЛЬ КАЧЕСТВА',
    '规格检查':'ПРОВЕРКА ДОПУСКА',
    '精准检查':'ТОЧНАЯ ПРОВЕРКА',
    '名义值':'НОМИНАЛ',
    '测量进行中':'ИЗМЕРЕНИЕ ИДЁТ',
    '物料清单数字线程':'ЦИФРОВАЯ ЦЕПОЧКА BOM',
    '工程分类':'ИНЖЕНЕРНАЯ КЛАССИФИКАЦИЯ',
    'A3 图纸':'ЧЕРТЁЖ A3',
    '版本':'РЕВИЗИЯ',
    '数字线程已连接':'ЦИФРОВАЯ ЦЕПОЧКА СВЯЗАНА',
    '生产过程 · 运行中':'ПРОЦЕСС ИДЁТ',
    '扭矩确认':'ПРОВЕРКА МОМЕНТА',
    '安全联锁':'БЛОКИРОВКА БЕЗОПАСНОСТИ',
    'AGV 路线':'МАРШРУТ AGV',
    '三坐标测头':'ЩУП CMM',
    '控制室':'ДИСПЕТЧЕРСКАЯ',
    '部件安装':'УСТАНОВКА ДЕТАЛИ',
    '表面扫描':'СКАН ПОВЕРХНОСТИ'
  });
  ...
  function russianStaticText() {
    if (String(snapshot().language || '') !== 'chinese') return;
  ...
  root.document.addEventListener('click', function (event) {
    ...
    if (event.target.closest('[data-language],[data-view="games"],[data-start-v618-game],[data-start-game],[data-fj2-stage]')) {
