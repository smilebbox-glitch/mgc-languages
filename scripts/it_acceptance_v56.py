...
parser=argparse.ArgumentParser(description='MGC Languages v5.6 runtime IT acceptance')
...
if args.report:
    ...
    rows=['# MGC Languages v5.6 — IT Acceptance Report','',f'- Generated: {datetime.now(timezone.utc).isoformat()}',f'- Target: `{base}`',f'- Auth mode: `{auth_mode}`',f'- Result: **{passed} PASS / {failed} FAIL / {skipped} SKIP**','', '| Check | Result | Detail |','|---|---|---|']
...
if failed:
    raise SystemExit(1)
print('PASS: v5.6 runtime IT acceptance')
