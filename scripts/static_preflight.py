...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth/learning/practice-game routers + security/governance/learning/services/workflows/auth core + Putonghua scope')
    ...
    print('PASS: v5.8.4 practice-games-router extraction preflight')
    return 0
