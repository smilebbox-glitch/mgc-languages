...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth/learning/practice-game/terminology-admin/pronunciation/users-manager routers + security/governance/learning/services/workflows/auth core + Putonghua scope')
    ...
    print('PASS: v5.8.7 users-manager-router extraction preflight')
    return 0
