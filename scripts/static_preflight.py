...
def main()->int:
    ...
    print('PASS: Python compile + modular runtime/system-observability routers/security/governance/learning/services/workflows/auth + Chinese foundations/Putonghua scope')
    ...
    print('PASS: v5.8.1 observability-router + Prometheus-renderer preflight')
    return 0
