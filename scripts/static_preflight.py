...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth/learning/practice-game/terminology-admin routers + security/governance/learning/services/workflows/auth core + Putonghua scope')
    ...
    print('PASS: v5.8.5 terminology-admin-router extraction preflight')
    return 0
