...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth/learning/practice-game/terminology-admin/pronunciation routers + security/governance/learning/services/workflows/auth/TTS core + Putonghua scope')
    ...
    print('PASS: v5.8.7 TTS-core extraction preflight')
    return 0
