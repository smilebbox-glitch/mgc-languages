...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth routers + security/governance/learning/services/workflows/auth core + Putonghua scope')
    ...
    print('PASS: v5.8.2 auth-router extraction preflight')
    return 0
