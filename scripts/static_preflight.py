...
def main()->int:
    ...
    print('PASS: Python compile + modular system/observability/auth/learning/practice-game/terminology-admin/pronunciation/user-manager/pilot-admin/admin-ops/notifications routers + security/governance/learning/services/workflows/auth/TTS core + Putonghua scope')
    ...
    print('PASS: v5.9.1 notifications-router extraction preflight')
    return 0
