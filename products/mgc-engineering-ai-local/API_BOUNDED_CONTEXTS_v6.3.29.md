# API Bounded Contexts — v6.3.27

> v6.3.27 adds no automotive bounded-context routes; Real Integration Certification remains an administrative integration/Operations concern.

Total bounded-context routes: **247**. Legacy v6.2.0 method/path contracts remain additive-compatible.

v6.3.27 adds no bounded-context engineering routes; the new integration certification endpoints remain in administrative integration/Operations, so automotive-domain ownership is unchanged.
