# API Bounded Contexts — v6.3.21

Total bounded-context routes: **247**. Legacy v6.2.0 method/path contracts remain additive-compatible.

v6.3.21 adds no bounded-context engineering routes; the new High Availability endpoint remains in administrative Operations, so automotive-domain ownership is unchanged.
