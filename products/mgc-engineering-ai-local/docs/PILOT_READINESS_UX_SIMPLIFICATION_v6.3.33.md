# MGC Engineering AI Local v6.3.33 — Pilot Readiness & UX Simplification
...
v6.3.33 не добавляет новый инженерный домен. Релиз сокращает когнитивную нагрузку перед реальным пилотом: инженер сначала видит проект, действия и рабочие объекты, а глубокие Digital Thread / Quality / Launch / Release evidence открывает только при необходимости.
...
- rolling/blue-green adjacent window: **6.3.32 ↔ 6.3.33**.
...
v6.3.33 намеренно не вводит автоматический «AI productivity score» и не делает выводы об эффективности сотрудника.
