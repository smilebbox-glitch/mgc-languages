# API Bounded Contexts — v6.3.29

> v6.3.29 adds no automotive bounded-context routes; Target-Host Deployment Assurance remains an Operations/release-engineering concern.

Total bounded-context routes: **247**. Legacy v6.2.0 method/path contracts remain additive-compatible.

v6.3.29 adds no bounded-context engineering routes; target-host probe/certification/deployment gating remains outside automotive-domain route ownership.
