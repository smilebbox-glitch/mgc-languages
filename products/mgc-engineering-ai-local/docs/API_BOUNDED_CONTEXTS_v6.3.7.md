# API Bounded Context Ownership — v6.3.7

Public paths remain under `/api/v1`. v6.3.7 preserves all 181 v6.2.0 legacy method/path contracts and adds controlled PLM/PDM/MES handover additively. External writes remain disabled by default.
