# API Bounded Context Ownership — v6.3.8

Public paths remain under `/api/v1`. v6.3.8 preserves all 181 v6.2.0 legacy method/path contracts and adds controlled data-lifecycle governance additively.
...
Total bounded-context routes: **237**. Legacy v6.2.0 surface: **181/181 preserved**.
