# API Bounded Context Ownership — v6.3.0

Public paths remain under `/api/v1`. v6.3.0 preserves all 181 v6.2.0 legacy method/path contracts and adds 12 work-instruction/BOM/layout APIs.
