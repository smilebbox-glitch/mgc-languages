# API Bounded Contexts — v6.3.26

> v6.3.26 adds no automotive bounded-context routes; Acceptance Evidence Registry & Release Provenance remains an Operations/release-engineering concern.

Total bounded-context routes: **247**. Legacy v6.2.0 method/path contracts remain additive-compatible.

v6.3.26 adds no bounded-context engineering routes; the new release-provenance endpoint remains in administrative Operations, so automotive-domain ownership is unchanged.
