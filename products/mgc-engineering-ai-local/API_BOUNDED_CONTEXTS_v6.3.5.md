# API Bounded Context Ownership — v6.3.5

Public paths remain under `/api/v1`. v6.3.5 preserves all 181 v6.2.0 legacy method/path contracts and adds approval/release governance additively.
